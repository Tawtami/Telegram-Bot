...
class TestNotifyAdmins:
    ...
    async def test_notify_admins_with_parse_mode(self):
        ...
        mock_bot.send_message.assert_called_once_with(chat_id=123, text=text, parse_mode=parse_mode)
...
class TestSendPaginatedList:
    ...
    async def test_send_paginated_list_empty_lines(self):
        ...
        with patch('utils.admin_notify.notify_admins') as mock_notify:
            ...
            mock_notify.assert_called_once_with(mock_context, admin_ids, "Test Title\n— خالی —")
    ...
    async def test_send_paginated_list_multiple_pages(self):
        ...
        with patch('utils.admin_notify.notify_admins') as mock_notify:
            ...
            # First page
            mock_notify.assert_any_call(mock_context, admin_ids, "Test Title\nLine 1\nLine 2")
            # Second page
            mock_notify.assert_any_call(mock_context, admin_ids, "Test Title\nLine 3\nLine 4")
