...
# -*- coding: utf-8 -*-
"""
Simple Telegram Bot for Math Course Registration (v13.15 compatible)
ربات ساده تلگرام برای ثبت‌نام کلاس‌های ریاضی (سازگار با نسخه 13.15)
"""
...
لطفاً یکی از گزینه‌های زیر را انتخاب کنید:
    ...
    def handle_callback(self, update: Update, context: CallbackContext):
        ...
        if query.data == "courses":
            self.show_courses(query)
        elif query.data == "book":
            self.show_book_info(query)
        elif query.data == "contact":
            self.show_contact_info(query)
        elif query.data == "social":
            self.show_social_links(query)
        elif query.data == "back_to_menu":
            self.show_main_menu(query)
    
    def show_courses(self, query):
        ...
        query.edit_message_text(courses_text, reply_markup=reply_markup)
    
    def show_book_info(self, query):
...
📞 برای خرید کتاب با استاد تماس بگیرید
        ...
        query.edit_message_text(book_text, reply_markup=reply_markup)
    
    def show_contact_info(self, query):
...
📍 آدرس: {CONTACT_INFO['address']}
        ...
        query.edit_message_text(contact_text, reply_markup=reply_markup)
    
    def show_social_links(self, query):
...
✅ برای اطلاع از آخرین اخبار و محتوا، کانال‌ها را دنبال کنید
        ...
        query.edit_message_text(social_text, reply_markup=reply_markup)
