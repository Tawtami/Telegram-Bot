...
class BotConfig:
    ...
    def __post_init__(self):
        if self.admin_user_ids is None:
            ...
            self.admin_user_ids = [
                # ادمین #1 - Taha (@F209EVRH) - استاد حاتمی (Master Hatami)
                # مسئول: دریافت اعلان‌های پرداخت، تایید خریدها، ارسال کتاب‌ها
                5464088773,  # شناسه کاربری Taha - استاد حاتمی
                
                # ادمین #2 - دستیار استاد (در صورت نیاز اضافه شود)
                # مسئول: پشتیبانی، مدیریت دانش‌آموزان، پاسخ به سوالات
                # 987654321,  # شناسه کاربری دستیار - لطفاً تغییر دهید
                
                # ادمین #3 - مدیر فنی (در صورت نیاز اضافه شود)
                # مسئول: مدیریت فنی ربات، پشتیبان‌گیری، گزارش‌گیری
                # 555666777,  # شناسه کاربری مدیر فنی - لطفاً تغییر دهید
            ]
...
class Config:
    ...
    def __init__(self):
        ...
        self.cities_by_province = {
            "آذربایجان شرقی": ["تبریز", "مراغه", "میانه", "اهر", "بناب", "سراب", "شبستر", "هریس", "ملکان", "ورزقان"],
            "آذربایجان غربی": ["ارومیه", "خوی", "مهاباد", "بوکان", "میاندوآب", "سلماس", "نقده", "پیرانشهر", "ماکو", "تکاب"],
            "اردبیل": ["اردبیل", "مشگین‌شهر", "خلخال", "پارس‌آباد", "گرمی", "نمین", "نیر", "کوثر", "بیله‌سوار", "سرعین"],
            "اصفهان": ["اصفهان", "کاشان", "نجف‌آباد", "خمینی‌شهر", "شاهین‌شهر", "فولادشهر", "مبارکه", "گلپایگان", "نطنز", "اردستان"],
            "البرز": ["کرج", "فردیس", "ماهدشت", "نظرآباد", "ساوجبلاغ", "طالقان", "اشتهارد", "هشتگرد", "محمدشهر", "مهرشهر"],
            "ایلام": ["ایلام", "دهلران", "مهران", "آبدانان", "ایوان", "دره‌شهر", "شیروان", "چوار", "ملکشاهی", "بدره"],
            "بوشهر": ["بوشهر", "برازجان", "گناوه", "کنگان", "جم", "دیلم", "خورموج", "تنگستان", "دیر", "عسلویه"],
            "تهران": ["تهران", "شهریار", "ورامین", "دماوند", "فیروزکوه", "پاکدشت", "ملارد", "رباط‌کریم", "اسلام‌شهر", "قدس"],
            "چهارمحال و بختیاری": ["شهرکرد", "بروجن", "فارسان", "لردگان", "کیار", "سامان", "گندمان", "باباحیدر", "کوهرنگ", "اردل"],
            "خراسان جنوبی": ["بیرجند", "قائنات", "فردوس", "نهبندان", "طبس", "درمیان", "سربیشه", "سرایان", "خوسف", "زیرکوه"],
            "خراسان رضوی": ["مشهد", "نیشابور", "سبزوار", "تربت حیدریه", "کاشمر", "گناباد", "تایباد", "خواف", "قوچان", "چناران"],
            "خراسان شمالی": ["بجنورد", "شیروان", "اسفراین", "جاجرم", "فاروج", "گرمه", "مانه و سملقان", "رازوجرگلان", "آشخانه", "پیش قلعه"],
            "خوزستان": ["اهواز", "دزفول", "آبادان", "خرمشهر", "ماهشهر", "بهبهان", "ایذه", "شوشتر", "اندیمشک", "رامهرمز"],
            "زنجان": ["زنجان", "ابهر", "خدابنده", "قیدار", "طارم", "ماهنشان", "خرمدره", "ایجرود", "سلطانیه", "صائین‌قلعه"],
            "سمنان": ["سمنان", "شاهرود", "دامغان", "گرمسار", "مهدی‌شهر", "میامی", "آرادان", "سرخه", "ایوانکی", "بسطام"],
            "سیستان و بلوچستان": ["زاهدان", "زابل", "چابهار", "ایرانشهر", "خاش", "سراوان", "نیکشهر", "کنارک", "سرباز", "راسک"],
            "فارس": ["شیراز", "مرودشت", "جهرم", "فسا", "کازرون", "لار", "داراب", "فیروزآباد", "آباده", "اقلید"],
            "قزوین": ["قزوین", "البرز", "تاکستان", "آوج", "بوئین‌زهرا", "آبیک", "محمودآباد", "الوند", "ضیاءآباد", "شال"],
            "قم": ["قم", "جعفریه", "کهک", "سلفچگان", "دستجرد", "قنوات", "قاهان", "نیمور", "آبگرم", "صالح‌آباد"],
            "کردستان": ["سنندج", "سقز", "بانه", "مریوان", "قروه", "کامیاران", "بیجار", "دیواندره", "دهگلان", "سروآباد"],
            "کرمان": ["کرمان", "رفسنجان", "جیرفت", "بم", "سیرجان", "کهنوج", "زرند", "بردسیر", "شهربابک", "راور"],
            "کرمانشاه": ["کرمانشاه", "اسلام‌آباد غرب", "کنگاور", "پاوه", "جوانرود", "قصرشیرین", "سنقر", "صحنه", "هرسین", "روانسر"],
            "کهگیلویه و بویراحمد": ["یاسوج", "گچساران", "دوگنبدان", "سی‌سخت", "دهدشت", "لنده", "چرام", "باشت", "بویراحمد", "مارگون"],
            "گلستان": ["گرگان", "گنبد کاووس", "علی‌آباد کتول", "بندرگز", "کردکوی", "آق‌قلا", "مینودشت", "رامیان", "کلاله", "آزادشهر"],
            "گیلان": ["رشت", "انزلی", "لاهیجان", "آستارا", "تالش", "رودبار", "فومن", "صومعه‌سرا", "لنگرود", "ماسال"],
            "لرستان": ["خرم‌آباد", "بروجرد", "دورود", "الیگودرز", "کوهدشت", "پل‌دختر", "ازنا", "نورآباد", "چگنی", "سپیددشت"],
            "مازندران": ["ساری", "بابل", "آمل", "قائم‌شهر", "نوشهر", "چالوس", "تنکابن", "نکا", "بهشهر", "فریدونکنار"],
            "مرکزی": ["اراک", "ساوه", "خمین", "محلات", "دلیجان", "تفرش", "شازند", "آشتیان", "کمیجان", "خنداب"],
            "هرمزگان": ["بندرعباس", "بندرلنگه", "قشم", "کیش", "میناب", "جاسک", "پارسیان", "حاجی‌آباد", "بستک", "گاوبندی"],
            "همدان": ["همدان", "ملایر", "نهاوند", "تویسرکان", "اسدآباد", "بهار", "کبودرآهنگ", "رزن", "فامنین", "قهاوند"],
            "یزد": ["یزد", "میبد", "اردکان", "بافق", "مهریز", "ابرکوه", "تفت", "خاتم", "بهاباد", "هرات"]
        }
