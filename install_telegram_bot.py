...
# -*- coding: utf-8 -*-
"""
Installation script for python-telegram-bot
اسکریپت نصب کتابخانه تلگرام
"""
...
def install_telegram_bot():
    ...
    methods = [
        ...
        },
        {
            ...
            "command": "pip install python-telegram-bot --trusted-host pypi.org --trusted-host pypi.python.org --trusted-host files.pythonhosted.org"
        },
        {
            "name": "روش ۳: نصب از GitHub",
            "command": "pip install git+https://github.com/python-telegram-bot/python-telegram-bot.git"
        },
        {
            "name": "روش ۴: نصب با mirror چینی",
            "command": "pip install python-telegram-bot -i https://pypi.tuna.tsinghua.edu.cn/simple/"
        },
        {
            "name": "روش ۵: نصب با mirror ایرانی",
            "command": "pip install python-telegram-bot -i https://pypi.python.org/simple/"
        }
    ]
